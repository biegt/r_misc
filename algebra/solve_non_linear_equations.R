...
func_values <- vector(mode = "numeric", 20000)
for (i in 1:20000) {
  x <- i - 10000
...
# Check for which x-values the function equals 0
func_values[func_values == 0]

# Save those values in a vector
roots <- as.numeric(names(func_values[func_values == 0]))
